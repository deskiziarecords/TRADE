...
class TradingModel:
    ...
    def detect_confluence_collapse(self):
        ...
        negative_expectancy = jnp.mean(self.returns[high_confidence]) < 0
...
# Example usage
confidence_scores = jnp.random.rand(100)  # Simulated confidence scores
returns = jnp.random.randn(100)  # Simulated returns
